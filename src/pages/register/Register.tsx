import profileValidationSchema from "../../validation/profileValicationSchema";
...
const Register = () => {
  const { error, isLoading, toast, signup } = useRegister();
  ...
  return (
    <div className="d-flex justify-content-center align-items-center login-background">
      <div className="container col-md-4 col-sm-12">
        ...
        {toast && <div className="text-success">{toast}</div>}
